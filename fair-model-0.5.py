...
gen_latent_nonparam_regula0 = gen_latent_nonparam_regula(result, protected_columns, target_column, 0.5)
...
plt.suptitle('Fair Model (lambda=0.5) Correlation Heatmap')
plt.show()

fig, axes = plt.subplots(2, 2, figsize=(18, 7))
fig.suptitle('Fair Model (lambda=0.5)')

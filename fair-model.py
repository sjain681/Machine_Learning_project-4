...
plt.suptitle('Fair Model (Fast) Correlation Heatmap')
plt.show()

fig, axes = plt.subplots(2, 2, figsize=(18, 7))
fig.suptitle('Fair Model (Fast)')

sns.scatterplot(ax=axes[0, 0], data=result_fair, x="percent_bachelorPlus", y="mean_valence", hue="totalGroup1")
sns.scatterplot(ax=axes[0, 1], data=result_fair, x="percent_bachelorPlus", y="mean_valence", hue="totalGroup2")
sns.scatterplot(ax=axes[1, 0], data=result_fair, x="households_meanIncome", y="mean_valence", hue="totalGroup1")
sns.scatterplot(ax=axes[1, 1], data=result_fair, x="households_meanIncome", y="mean_valence", hue="totalGroup2")
plt.show()
...
gen_latent_nonparam_regula0 = gen_latent_nonparam_regula(result, protected_columns, target_column, 0)
...
plt.suptitle('Fair Model (lambda=0) Correlation Heatmap')
plt.show()

fig, axes = plt.subplots(2, 2, figsize=(18, 7))
fig.suptitle('Fair Model (lambda=0)')
...
gen_latent_nonparam_regula1 = gen_latent_nonparam_regula(result, protected_columns, target_column, 1)
...
plt.suptitle('Fair Model (lambda=1) Correlation Heatmap')
plt.show()

fig, axes = plt.subplots(2, 2, figsize=(18, 7))
fig.suptitle('Fair Model (lambda=1)')
